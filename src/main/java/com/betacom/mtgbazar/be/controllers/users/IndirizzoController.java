...
public class IndirizzoController {
   ...
   @GetMapping
   public List<IndirizzoDTO> list(@RequestParam Long utenteId) {
       log.debug("GET /api/indirizzi?utenteId={}", utenteId);
   ...
   public void setPredefinito(@PathVariable Long id, @RequestParam Long utenteId) {
